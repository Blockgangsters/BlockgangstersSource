...
import {Navbar, Footer, Gamebar} from './components';
...
// --------------------- get all values initially ------------
  ...
  <StyledPopup open={crowdfundPopup} position="center center" modal closeOnDocumentClick>
        ...
        <Switch>
            ...
            <Route path={`${process.env.PUBLIC_URL}/helppage`} exact component={Helppage} />
            <Route path={`${process.env.PUBLIC_URL}/roadmap`} exact component={Roadmap} />
            <Route path={`${process.env.PUBLIC_URL}/contract`} exact component={Contract} />
            <Route path={`${process.env.PUBLIC_URL}/whitepaper`} exact component={Whitepaper} />
            <Route path={`${process.env.PUBLIC_URL}/tokenomics`} exact component={Tokenomics} />
            <Route path={`${process.env.PUBLIC_URL}/deposit`} exact component={Deposit} />
            <Route path={`${process.env.PUBLIC_URL}/indprotection`} exact component={IndProtection} />
            <Route path={`${process.env.PUBLIC_URL}/attackplayer`} exact component={Attackplayer} />
            <Route path={`${process.env.PUBLIC_URL}/crime`} exact component={Crime} />
            <Route path={`${process.env.PUBLIC_URL}/crowdfunding`} exact component={Crowdfunding} />
            <Route path={`${process.env.PUBLIC_URL}/trainstats`} exact component={Trainstats} />
            <Route path={`${process.env.PUBLIC_URL}/familycontrol`} exact component={Familycontrol} />
            <Route path={`${process.env.PUBLIC_URL}/attackfamily`} exact component={Attackfamily} />
            <Route path={`${process.env.PUBLIC_URL}/overview`} exact component={Overview} />
            <Route path={`${process.env.PUBLIC_URL}/familyshop`} exact component={Familyshop} />
            <Route path={`${process.env.PUBLIC_URL}/statistics`} exact component={Statistics} />
            <Route path={`${process.env.PUBLIC_URL}/highestlevels`} exact component={Highestlevels} />
            <Route path={`${process.env.PUBLIC_URL}/richestplayers`} exact component={Richestplayers} />            
            </Switch>
            <Footer />
            </Router>
            </EthContext.Provider>
